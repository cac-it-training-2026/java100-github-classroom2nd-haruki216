...
public class Astronaut {
	...
	public static void main(String[] args) throws IOException {
		...
		int res = space.consumingFuel();
		System.out.println("航行距離：" + res + "光年");

		//ここに適切な処理を記述する。
		space.consumingFuel(space.getFuel());
		System.out.println("航行距離：" + space.getFuel());
		...
		//ここに適切な処理を記述する。
		res = space.consumingFuel(consumingFuel);
		System.out.println("航行距離：" + res + "光年\n");
