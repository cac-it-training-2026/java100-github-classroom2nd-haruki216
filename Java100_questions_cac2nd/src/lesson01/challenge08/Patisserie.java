...
public class Patisserie {
	public static void main(String[] args) throws IOException {
		...
		System.out.println("またのお越しをお待ちしています");

		System.out.println("本日の割合\n売上合計 " + totalPrice);

		//それぞれの売り上げ割合を計算　個々の金額から全体の金額を割る
		int stP = (int) ((citronBuyCount * 250) / totalPrice * 100);
		int sykP = (int) ((chocolatBuyCount * 280) / totalPrice * 100);
		int pisP = (int) ((pistacheBuyCount * 320) / totalPrice * 100);

		System.out.println("内訳");
		System.out.println("シトロン　　　" + "\\" + (int) (250 * citronBuyCount) + "・・・" + stP + "%");
		System.out.println("ショコラ　　　" + "\\" + (int) (280 * chocolatBuyCount) + "・・・" + sykP + "%");
		System.out.println("ピスターシュ　" + "\\" + (int) (320 * pistacheBuyCount) + "・・・" + pisP + "%");
	}
